...
- [Fuzzy search trên cột phone_number đã mã hoá](/database/03-fuzzy-search-encrypted-column) — blind index, leakage và trade-off khi cần search trên encrypted data.
